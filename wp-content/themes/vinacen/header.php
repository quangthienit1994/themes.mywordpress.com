	        ...
	        <div class="container ct-navbar-container">
	            ...
	            <ul>
	                <li class="ct-wooCart dropdown">
	                    <a href="http://farmfresh.themeplayers.net/cart/" title="View your shopping cart">
	            ...
	            <nav class="ct-topBar-navigation pull-left">
	                <ul class="list-unstyled list-inline">
	                    <li><a href="http://farmfresh.themeplayers.net/my-account/" title="Login / Register">Login / Register</a></li>
	                </ul>
        ...
        <div class="container ct-navbar-container">       
            ...
            <div class="navbar-header">
                <a  href="<?php echo esc_url( home_url( '/' ) ); ?>" class="navbar-brand" >
                	<img  src="http://farmfresh.themeplayers.net/wp-content/uploads/2015/08/logo.png" alt="Farmfresh" class="navbar-brand-defaultColor" >
                </a>            
            </div>
