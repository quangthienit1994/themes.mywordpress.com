 ...
 * Description: <code><strong>YITH WooCommerce Stripe</strong></code> allows your users to pay with credit card thanks to the integration with Stripe, a powerful and flexible payment gateway. It lets you get payments with credit card and assures your users of the reliability of an international partner. <a href="https://yithemes.com/" target="_blank">Find new awesome plugins by <strong>YITH</strong></a>
 * Version: 1.7.1
 * Author: YITH
...
if ( defined( 'YITH_WCSTRIPE_VERSION' ) ) {
	...
	define( 'YITH_WCSTRIPE_VERSION', '1.7.1' );
}

if( ! defined( 'YITH_WCSTRIPE_API_VERSION' ) ){
	define( 'YITH_WCSTRIPE_API_VERSION', '2018-09-24' );
}
